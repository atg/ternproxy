...
marked.setOptions({
  ...
  highlight: function (code, lang) {
    ...
    try {
      highlighted = hljs.highlight('javascript', code).value;
    } catch (e) {
      console.trace('Highlight ERROR', e)
      return highlighted;
    }
  }
});

function addTagsTable (tags) {
  var returns = '<hr>';
  var types = {};
...
function intoDOC (comments, aval, type) {
