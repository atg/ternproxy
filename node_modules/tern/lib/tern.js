...
(function(mod) {
    ...
    function gather(prop, obj, depth) {
      ...
      if (query.types || query.docs || query.urls || query.origins) {
        ...
        if (query.docs)
          ...
          maybeSet(rec, "html", val.html || type && type.html);
        if (query.urls)
  ...
  function findDocs(_srv, query, file) {
    var expr = findExpr(file, query);
    var type = infer.expressionType(expr);
    var result = {url: type.url, doc: type.doc, html: type.html};
  ...
  function storeTypeDocs(type, out) {
    ...
    if (!out.html) out.html = type.html;
    if (!out.origin) out.origin = type.origin;
    var ctor, boring = infer.cx().protos;
    if (!out.url && (!out.doc && !out.html) && type.proto && (ctor = type.proto.hasCtor) &&
  ...
  function findDef(srv, query, file) {
    ...
    var result = {url: type.url, doc: type.doc, html: type.html, origin: type.origin};
