...
<script src="acorn-jsx.js"></script>
  ...
  <script src="../tern_1.5.1/lib/infer.js"></script>
  ...
  <body>
    ...
    <h1>Demo with React Tern plugin </h1>
	<p>See <a href="https://github.com/angelozerr/tern-react">https://github.com/angelozerr/tern-react</a> for more infos.</p>  
    <form><textarea id="code" name="code">// Input (JSX):
  ...
  window.isLoggedIn ? React.createElement(Nav) : React.createElement(Login)
    ...
    <script type="text/javascript">
      ...
      var editor = CodeMirror.fromTextArea(document.getElementById("code"), {
    	...
    	//textHover: {delay:300},
    	ternWith: { plugins: {"doc_comment": {}, "react" : {}}}
      });
    </script>
