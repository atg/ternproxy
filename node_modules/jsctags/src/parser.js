...
Parser.prototype.parse = function (fn) {
  ...
  if (Object.keys(self.ctx.condense).length) {
    return self.hasCondense(self.ctx.condense, fn);
  }
  ...
  condense(self.ctx, function (err, condense) {
    ...
    self.hasCondense(condense, fn);
  });
};

Parser.prototype.hasCondense = function (condense, fn) {
  this.condense = condense;

  if (condense['!define']) {
    this.define = condense['!define'];
  }

  this.fromTree(condense);
